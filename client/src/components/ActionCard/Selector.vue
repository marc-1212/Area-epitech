...
import { fetchUserRedditOAuth } from '../../actioncardServices.js'
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      items_s1_reaction: ['Discord', 'Joke', 'Anime', 'Football', 'Weather'],
      items_s2_reaction: [],
  ...
  mounted() {
    fetchUserRedditOAuth(localStorage.getItem("userId")).then((res) => {
      if (res.data.result[0].reddit_token != null) {
        this.items_s1_reaction.push('Reddit');
      }
    });
  }
})
