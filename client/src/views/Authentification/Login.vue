  ...
  <div class="min-h-screen bg-gray-700 py-6 flex flex-col justify-center sm:py-12">
	  <div class="relative py-3 sm:max-w-xl sm:mx-auto">
	  	<div class="absolute inset-0 bg-gradient-to-r from-purple-300 to-purple-600 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl"></div>
            ...
            <div>
	  	  			<h1 class="text-3xl text-center font-semibold">Login to Area</h1>
	  	  		</div>
	  	  		<!---Sign in form input---->
                ...
                <div class="mb-6">
                  ...
                  >Having troubles signing in?</a>
                </div>
                <!-- Submit button-->
                <button class="inline-block px-7 py-3 bg-purple-400 text-white font-medium text-sm leading-snug uppercase text-center rounded-2xl shadow-md hover:bg-purple-500 hover:shadow-lg focus:bg-purple-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-500 active:shadow-lg transition duration-150 ease-in-out w-full" @click="fetchUser" tag="button">Sign in</button>
              <!-- Other Signing up methods -->
                <!-- Line asking how to sign in -->
                <div class="flex items-center my-4 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 after:border-t after:border-gray-300 after:mt-0.5">
                  <p class="text-center text-base font-semibold mx-4 mb-0">Or Sign in with</p>
                </div>
                ...
                <div>
                  ...
                  <div class="flex items-center my-4 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5"></div>
                  <p class="mx-2 text-center text-base">Don't have an account?</p>
                  <router-link class="my-4 flex justify-center text-base font-bold hover:underline" to="/signup" >Register here</router-link>
                </div>
	  	  			</div>
	  	  		</div>
	  	  	</div>
