...
export default defineComponent({
  ...
  methods: {
    action() {
      ...
      updateCardsReaction('Joke', 'SendJoke', 'jokeChannel', this.channel, this.localId, localStorage.getItem("userId")).then((res) => {
        console.log(res);
      })
    }
  },
  created() {
    ...
    this.channel = this.jokeChannel ? this.jokeChannel : '';
  }
})
</script>
